...
card1 = cardImg("AIDA MARINA QUILCUE VIVAS", "AIDA MARINA QUILCUE VIVAS", 'A', 'politica indigena')
...
imgPartidoGenero = plotGrouptwo('Procesos por partido', listaPartidos,'Partido','Genero','Partido','Senadores')
